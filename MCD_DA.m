...
while loop_convergence4==0
    ...
    for i=1:c_num
        for j=1:c_num
            ...
            results=search_Z_loop_vertex_in(1,c_num,i,j,In_V_Mat,In_I_Mat,c_num);%1
            results_set(1)=results;
            if results==1
                 Z_loop_update();
                for k=1:size(Z_circle.v_c,2)
            ...
            results=search_Z_loop_vertex_de(1,c_num,i,j,De_V_Mat,De_I_Mat,c_num);%3
...
% sub_function 4
function results=search_Z_loop_vertex_in(c_min,c_max,i1,k1,In_V_Mat,In_I_Mat,sw2)
    results=0;
    temp_c=c_min:c_max;
    temp_c2=c_min:c_max;
    for i_sw=1:sw2
...
% sub_function 5
function results=search_Z_loop_vertex_de(c_min,c_max,i1,k1,De_V_Mat,De_I_Mat,sw2)
    results=0;
    temp_c=c_min:c_max;
    temp_c2=c_min:c_max;
    for i_sw=1:sw2
